...
export const nigerianStates = [
  ...
  },
  {
    ...
    lgas: [
      ...
      'Gaya', 'Gezawa', 'Gwarzo', 'Kabo', 'Kano Municipal', 'Karaye', 'Kibiya', 'Kiru',
  ...
  },
  {
    ...
    lgas: [
      ...
      'Ibadan', 'Katcha', 'Kontagora', 'Lapai', 'Lavun', 'Magama', 'Mariga', 'Mashegu',
...
// Helper function to get LGAs by state ID
export const getLGAsByStateId = (stateId) => {
...
// Helper function to get all state IDs
export const getAllStateIds = () => {
  return nigerianStates.map(state => state.id)
}
